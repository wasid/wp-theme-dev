            ...
            <div class="row" id="primary">
                <div id="content" class="col-sm-12">
                    <section class="main-content">
                        <p class="lead">
                            Welcome to the Bootstrap to WordPress resources page! On this page, I will provide you with useful resources, plugins, tools, applications, and websites to help make your life as a coder a little bit easier. <strong>I recommend adding this page to your bookmarks for convenient future reference.
                        </strong>
                        </p>
                        <p><em>
						...
						<div class="resource">
							<img src="http://bootstraptowordpress.com/wp-content/uploads/2014/12/justhost-logo.jpg" alt="Justhost Logo">
						...
						<div class="resource">
    						<img src="http://bootstraptowordpress.com/wp-content/uploads/2014/12/coda2-logo.jpg" alt="Coda 2 Logo">
						...
						<div class="resource">
							<img src="http://bootstraptowordpress.com/wp-content/uploads/2014/12/dropbox-logo.jpg" alt="Dropbox Logo">
                            ...
                            <a href="#" class="btn btn-success">Get 2GB in Dropbox for free</a>
					    </div><!-- resource -->
					</div>
                    </section>
                </div>
