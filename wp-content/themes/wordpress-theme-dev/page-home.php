...
get_header(); ?>
            ...
            <div class="container clearfix">
                <div class="row">
                    ...
                    <div class="col-sm-7 hero-text">
                        ...
                        <p class="load">
                            Earn And Ectra $1k - $5k a Month by Kearning to Code very own responsive &amp; custom worrdpress websites with bootstrap
                        </p>
    ...
    <section id="boost-income">
        <div class="container">
            <div class="section-header">
                <img src="<?php bloginfo('stylesheet_directory'); ?>/assets/img/icon-boost.png" att="Chart">
                <h2>How You Can Boots Your Income</h2>
            </div>
            <p class="lead">
    ...
    <section id="who-benefits">
        <div class="container">
            <div class="section-header">
                <img src="<?php bloginfo('stylesheet_directory'); ?>/assets/img/icon-pad.png" att="Chart">
                <h2>How You Can Boots Your Income</h2>
            </div>
            <div class="row">
